...
$opening = Get-SourcePath $repositoryRoot $OpeningFile 'tests\data\openings\openings-curated-32.txt'
$fen = Get-SourcePath $repositoryRoot $FenFile 'tests\data\positions\evaluation-positions.txt'
