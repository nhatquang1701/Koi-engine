...
and verification evidence. Generated contents are ignored by Git; keep only
durable navigation or provenance documentation tracked.

| Directory | Contents |
| --- | --- |
| `baselines/` | reproducible benchmark and test baselines |
| `matches/` | UCI and engine-match reports and PGNs |
