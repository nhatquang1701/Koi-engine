...
PGN_FORENSICS_SCRIPT = REPOSITORY_ROOT / "tools" / "pgn_forensics.py"
GIGABASE_SCRIPT = REPOSITORY_ROOT / "tools" / "gigabase_extract.py"
FIXTURE_PATH = REPOSITORY_ROOT / "tests" / "data" / "measurement-forensics.json"
